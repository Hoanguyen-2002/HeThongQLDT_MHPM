...
public class JP_ThongKeDiemSinhVien extends javax.swing.JPanel {


    public JP_ThongKeDiemSinhVien() {
        try {
            initComponents();
            String reportname = "ThongKeDiemSV.jasper";
            ...
            Logger.getLogger(JP_ThongKeDiemSinhVien.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
