 ...
 class DAL_Lop extends DataAccessHelper {
    ...
    public ArrayList<DBO_LOP> getAllLop() {
        ...
        try {
            ...
            method.showMessegaWa("DAL_Lop getAll() Có Lỗi : " + e.toString());
        }
        getClose();
        return objs;
    }
    ...
    public ArrayList<DBO_LOP> getAllLop_dk(String MaLop) {
        ...
        try {
            ...
            method.showMessegaWa("DAL_Lop getAllLop() Có Lỗi : " + e.toString());
        }
        getClose();
        return objs;
    }
    ...
    public boolean Insert(DBO_LOP item) {
        ...
        try {
            ...
            store_proc.setString(4, item.getMaGiangVien());
    ...
    public ArrayList<DBO_LOP> Check_Lop(String MaLop) {
        ...
        try {
            ...
            method.showMessegaWa("DAL_Khoa chech Khoa dk() Có Lỗi : " + e.toString());
        }
        getClose();
        return objs;
    }
    ...
    public boolean Update(DBO_LOP item, String dk) {
        ...
        try {
            ...
            method.showMessegaWa("DAL_Lop update Có Lỗi : " + e.toString());
        }
        getClose();
        return check;
    }
    ...
    public boolean Delete(String MaLop) {
        ...
        try {
            ...
            method.showMessegaWa("DAL_Lop Delete Có Lỗi : " + e.toString());
        }
        getClose();
        return check;
    }
